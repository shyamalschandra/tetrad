 ...
 * @author jdramsey
 */
public class woIPcStable implements Algorithm, TakesInitialGraph, HasKnowledge, TakesIndependenceWrapper {
    ...
    public woIPcStable(IndependenceWrapper test) {
        this.test = test;
    }

    public woIPcStable(IndependenceWrapper test, Algorithm algorithm) {
        this.test = test;
...
//            	initialGraph = algorithm.search(dataSet, parameters);
    ...
    public String getDescription() {
        return "woIPC-Stable (\"Peter and Clark\" Stable), Priority Rule, using " + test.getDescription() + (algorithm != null ? " with initial graph from " +
