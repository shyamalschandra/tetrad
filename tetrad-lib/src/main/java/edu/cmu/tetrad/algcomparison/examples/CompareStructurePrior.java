...
import edu.cmu.tetrad.algcomparison.score.ConditionalGaussianExactBicScore;
 ...
 * @author jdramsey
 */
public class CompareStructurePrior {
    public static void main(String... args) {
        ...
        statistics.add(new ParameterColumn("fDegree"));
...
//        algorithms.add(new Cpc(new MNLRLRT(), new Mgm()));
        ...
        comparison.compareFromFiles("comparison", "structprior_comp", algorithms, statistics, parameters);
    }
}
