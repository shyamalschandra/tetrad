...
@edu.cmu.tetrad.annotation.Algorithm(
        name = "Fask-B Orientation",
        command = "fask-b_orientation",
...
public class FaskBOrientation implements Algorithm, TakesInitialGraph, HasKnowledge {
    ...
    public FaskBOrientation() {
    }

    public FaskBOrientation(Algorithm algorithm) {
    ...
    public Graph search(DataModel dataSet, Parameters parameters) {
        if (parameters.getInt("bootstrapSampleSize") < 1) {
            ...
            search.setDelta(parameters.getDouble("faskbDelta"));
            ...
            FaskBOrientation r3 = new FaskBOrientation(algorithm);
            if (initialGraph != null) {
