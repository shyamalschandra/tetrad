...
public class ExampleCompareSimulationDiscrete {
    public static void main(String... args) {
        ...
        parameters.set("samplePrior",  1, 5, 10, 15, 20, 25, 30, 50, 100, 200);
        parameters.set("structurePrior", 1, 2, 3);
...
//        comparison.setParallelized(true);
        ...
        comparison.compareFromSimulations("comparison.discrete-2_4categories", simulations, "comparison_all_" + sampleSize, algorithms, statistics, parameters);
    }
}
