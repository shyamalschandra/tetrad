...
import edu.cmu.tetrad.algcomparison.algorithm.intervention.Intervention;
...
public class CGISimulation implements Simulation {
    ...
    public void createData(Parameters parameters) {
        ...
        this.percentIDiscrete = parameters.getInt("percentIDiscrete");
