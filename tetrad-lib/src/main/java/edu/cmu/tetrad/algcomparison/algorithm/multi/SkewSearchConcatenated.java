...
@edu.cmu.tetrad.annotation.Algorithm(
        name = "Skew Search Concatenated",
        command = "skewsearch-concatenated",
        algoType = AlgType.forbid_latent_common_causes
)
public class SkewSearchConcatenated implements MultiDataSetAlgorithm, HasKnowledge, TakesIndependenceWrapper {

    static final long serialVersionUID = 23L;
    private IndependenceWrapper test;
    private IKnowledge knowledge = new Knowledge2();

    public SkewSearchConcatenated() {

    }

    public SkewSearchConcatenated(IndependenceWrapper test) {
        this.test = test;
    }
...
//            dataSet.setNumberFormat(new DecimalFormat("0.000000000000000000"));
            ...
            SkewSearchConcatenated algorithm = new SkewSearchConcatenated(test);
    ...
    public String getDescription() {
        return "Skew Search Concatenated";
    }
